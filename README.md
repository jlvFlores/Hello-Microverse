...
> A simple HTML project, created in block 1.

**[Hello-Microverse]** is a test to see if I understand how to create a professional repository.
...
- An HTML file with a heading
- A CSS file with a color style
- A fancy README file
...
Clone this repository to your desired folder:
    https://github.com/jlvFlores/Hello-Microverse.git
